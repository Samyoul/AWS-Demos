...
Usage:
  ...
  python snapshot restore <name>    Restores the snapshot of the given name
...
```bash
python snapshot restore <name>
```

Example:

```bash
python snapshot restore 2018-08-24
```
